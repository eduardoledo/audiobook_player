...
2. **Interactive Option Selection**: Use the `ask_question` interactive tool for every question so the user can directly select from the listed options via UI buttons.
